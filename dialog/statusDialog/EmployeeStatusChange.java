 ...
 * @author dulan
 */
public class EmployeeStatusChange extends javax.swing.JDialog {

    /**
     * Creates new form EmployeeStatusChange
     */
     private static AddNewEmployee addNewEmployee;
      Map<String, Integer> statusMap = new HashMap<>();
     
    public EmployeeStatusChange(AddNewEmployee addNewEmployee1, boolean model, AddNewEmployee aThis) {
        super(addNewEmployee1, model);
        this.addNewEmployee = aThis;
    ...
    public void loadEmployeeDetails(){
          try {
            ...
            EmployeeIDComboBox.setModel(dcm);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Change Employee Status");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(EmployeeIDComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String sql = "UPDATE employee SET `status_id` = ? WHERE `employee_id` = ?";
            String[] params = { statusName1, EmployeeID};
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EmployeeStatusChange dialog = new EmployeeStatusChange(addNewEmployee, true, addNewEmployee);
