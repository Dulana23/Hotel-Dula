 ...
 * @author dulan
 */
public class SupplierStatusChange extends javax.swing.JDialog {

    /**
     * Creates new form SupplierStatusChange
     */
    private static AddNewSupplier addNewSupplier;
    Map<String, Integer> statusMap = new HashMap<>();
    
    public SupplierStatusChange(AddNewSupplier addNewSupplier1, boolean model, AddNewSupplier aThis) {
        super(addNewSupplier1, model);
        this.addNewSupplier = aThis;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Change Supplier Status");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(SupplierIDComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String InvoiceID =(String) SupplierIDComboBox.getSelectedItem();
        ...
        try {
            ...
            String sql = "UPDATE supplier SET `status_id` = ? WHERE `supplier_id` = ?";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SupplierStatusChange dialog = new SupplierStatusChange(addNewSupplier, true, addNewSupplier);
